...
import BatchManagerPage from '~/routes/padavali/(auth)/_auth/batch_manager/-BatchManagerPage';

export const Route = createFileRoute('/padajala/(auth)/_auth/batch_manager/')({
  head: () => routeHeadFromPageMeta({ title: 'Crossword Batch Manager', project: 'padajala' }),
  component: CrosswordBatchManager
});

function CrosswordBatchManager() {
  return (
