...
export const Route = createFileRoute('/padajala/(auth)/_auth/schedules/')({
  loader: () => loader$(),
  head: () => routeHeadFromPageMeta({ title: 'Crossword Schedules', project: 'padajala' }),
  component: CrosswordSchedulesRoute
});

function CrosswordSchedulesRoute() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <Button
          render={<Link to="/padajala/schedules/add" className="inline-flex items-center gap-2" />}
          nativeButton={false}
          variant={'outline'}
        >
        ...
        {upcomming_schedules.length === 0 ? (
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <Button
                render={
                  <Link to="/padajala/schedules/add" className="inline-flex items-center gap-2" />
                }
                nativeButton={false}
                variant="link"
              >
