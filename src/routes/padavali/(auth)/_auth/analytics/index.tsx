...
const PuzzleStats = lazy(() => import('../edit/-PuzzleStats'));

export const Route = createFileRoute('/padavali/(auth)/_auth/analytics/')({
  head: () => routeHeadFromPageMeta({ title: 'Padavali Analytics' }),
