...
function usePuzzleSelectorListQuery(page: number, searchTitle: string, open: boolean) {
  const puzzleListQ = useQuery({
    queryKey: ['puzzle_selector_list', page, searchTitle],
    queryFn: () =>
...
const PuzzlePickerPopover = ({
  ...
  const { isLoading, isSuccess, isFetching, puzzleList, hasPrev, hasNext } =
    usePuzzleSelectorListQuery(page, debouncedSearchTitle, open);
          ...
          <div className="flex items-center gap-2">
            <InputGroup className="flex-1">
              ...
              <InputGroupInput
                ...
                onBeforeInput={(e) =>
                  handleTypingBeforeInputEvent(ctx, e, setSearchTitle, lipiLekhikaTyping)
                }
