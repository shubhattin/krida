...
import { OpenAIChatLanguageModelOptions, OpenAIImageModelGenerationOptions } from '@ai-sdk/openai';
import { z } from 'zod';
...
export const generatePuzzleImage = async (
  ...
  const compressed_buffer = await resizeImage(raw_buffer, IMAGE_STORED_WIDTH, IMAGE_STORED_HEIGHT, {
    quality: 82,
    effort: 3
  });
