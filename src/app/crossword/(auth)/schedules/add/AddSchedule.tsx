...
const AddSchedule = (props: Props) => {
  ...
  const add_schedule_mut = client_q.crossword.schedules.add_puzzle_schedule.useMutation({
    onSuccess(data) {
      if (data.success) {
        ...
        void invalidatePage('/crossword/schedules');
        void invalidatePage('/crossword/puzzles');

        router.push(`/crossword/schedules`);
  ...
  const update_schedule_mut = client_q.crossword.schedules.update_puzzle_schedule.useMutation({
    onSuccess(data) {
      if (data.success) {
