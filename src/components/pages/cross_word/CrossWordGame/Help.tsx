            ...
            <AccordionContent className="pb-4">
              <div className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
                <div className="flex items-start gap-2">
                  ...
                  <p>
                    Tap a cell to select a clue, then type letters with your keyboard or the
                    on-screen keys. Use arrows or tap again to switch between Across and Down.
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  <p>
                    Fill every word correctly to complete the puzzle. Solved words stay locked so
            ...
            <AccordionContent className="pb-4">
              <div className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
                <div className="flex items-start gap-2">
                  ...
                  <p>
                    Share the puzzle link or your solving time with friends. Tag us{' '}
