...
ALTER TABLE "word_puzzles" ADD COLUMN "description" text;--> statement-breakpoint
ALTER TABLE "word_puzzles" ADD COLUMN "archived" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "word_puzzles" ADD COLUMN "games_started" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
